...
<div id="footer-wrapper">
        ...
        <?php } ?>
         <div class="copyright-wrapper">
        	<div class="container">
           		 <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','natural-herbs-lite');?> <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/free-wordpress-themes/');?>" target="_blank">
        <?php esc_html_e('SKT Free Themes','natural-herbs-lite'); ?>
        </a></div>
                 <div class="clear"></div>
            </div>           
        </div>
